...
[![](https://fasthub.cc/zloyshadow/
yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)](https://fasthub.cc/zloyshadow/
yamdb_final/actions/workflows/yamdb_workflow.yml)
### Стек
...
```
git clone https://github.com/ZloyShadow/infra_sp2.git
```
